...
if __name__ == '__main__':
    ...
    solver.CL_alpha_w_cruise = solver.CL_alpha_DATCOM(A=solver.A, M=solver.M_cruise, sweep_half=solver.sweep_half)
    solver.CL_alpha_h_cruise = solver.CL_alpha_DATCOM(A=solver.A_h, M=solver.M_cruise_tail, sweep_half=solver.sweep_half_h)
    solver.CL_alpha_w_landing = solver.CL_alpha_DATCOM(A=solver.A, M=solver.M_landing, sweep_half=solver.sweep_half)
    solver.CL_alpha_h_landing = solver.CL_alpha_DATCOM(A=solver.A_h, M=solver.M_landing_tail, sweep_half=solver.sweep_half_h)
